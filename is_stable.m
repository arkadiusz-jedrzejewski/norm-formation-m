...
if is_annealed
    ...
    F00 = -s-(1-s)*conf_fun(a,q,is_symmetric)+(1-a0)*(1-s)*conf_dfun(a,q,is_symmetric)*(1-p)-...
        (1-s)*conf_fun(1-a,q,is_symmetric)+a0*(1-s)*conf_dfun(1-a,q,is_symmetric)*(1-p);
    F01 = (1-a0)*(1-s)*conf_dfun(a,q,is_symmetric)*p+a0*(1-s)*conf_dfun(1-a,q,is_symmetric)*p;
